<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ERP.Master" Inherits="System.Web.Mvc.ViewPage<ERP.Domain.Model.ApprealInfoEntity>" %>
...
<div class="mp_left_menu">
    ...
    <div class="mp_right_content">
            ...
            <div><%--<div style="text-align: center" > Apparel Department Wise</div>--%>
                ...
                Department Name: <%: Html.DropDownListFor(m => m.DeptName, (List<SelectListItem>)ViewData["DeptName"], "Select Dept.", new { @class = "width: 150px" })%> &nbsp; &nbsp;&nbsp;
...
<script type="text/javascript">
    function printItem() {
        alert("Report");
        window.open("/Deptwise/AppearlDeptrpt");
    }
</script>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            pageSize: 100,
            sorting: false,
            title: ' Apparel Department Wise',
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/Deptwise/AppearlDeptList") %>'
            },
            fields: {
                //                    Id: {
                //                        key: true,
