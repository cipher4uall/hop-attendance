...
<div class="mp_left_menu">
    ...
    <div class="mp_right_content">
            ...
            <div><%--<div style="text-align: center" > Wel Form Department Wise</div>--%>
...
<script type="text/javascript">
    function printItem() {
        alert("Report");
        window.open("/Deptwise/WelformDeptrpt");
    }
</script>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            pageSize: 100,
            sorting: false,
            title: ' Wel Form Department Wise',
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/Deptwise/WelformDeptList") %>'
            },
            fields: {
                //                    Id: {
                //                        key: true,
