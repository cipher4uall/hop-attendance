...
<div class="mp_left_menu">
    ...
    <div class="mp_right_content">
            ...
            <div><%--<div style="text-align: center"> Manager Department Wise</div>--%>
...
<script type="text/javascript">
    function printItem() {
        alert("Report");
        window.open("/Deptwise/-ManagerDeptrpt");
    }
</script>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            pageSize: 100,
            sorting: false,
            title: 'Manager Department Wise',
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/Deptwise/ManagerDeptList") %>'
            },
            fields: {
                //                    Id: {
                //                        key: true,
