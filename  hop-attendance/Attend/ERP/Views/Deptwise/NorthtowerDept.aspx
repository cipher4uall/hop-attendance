...
<div class="mp_left_menu">
    ...
    <div class="mp_right_content">
            ...
            <div><%--<div style="text-align: center"> North Tower Department Wise</div>--%>
                ...
                <input type="button" value="Excel Report" title="Print"   onclick="printItemEx()" />
            </div>
...
<script type="text/javascript">
    function printItem() {
        alert("Report");
        window.open("/Deptwise/NorthtowerDeptrpt");
    }
</script>
<script type="text/javascript">
    function printItemEx() {
        alert("Report");
        window.open("/Deptwise/-NorthtowerDeptrptExcel");
    }
</script>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            pageSize: 100,
            sorting: false,
            title: 'North Tower Department Wise',
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/Deptwise/NorthtowerDeptList") %>'
            },
            fields: {
                //                    Id: {
                //                        key: true,
