...
<div class="mp_left_menu">
    ...
    <div class="mp_right_content">
            ...
            <div><%--<div style="text-align: center" > BD Department Wise</div>--%>
...
<script type="text/javascript">
    function printItem() {
        alert("Report");
        window.open("/Deptwise/BDDeptrpt");
    }
</script>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            pageSize: 100,
            sorting: false,
            title: 'BD Department Wise',
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/Deptwise/BDDeptList") %>'
            },
            fields: {
                //                    Id: {
                //                        key: true,
