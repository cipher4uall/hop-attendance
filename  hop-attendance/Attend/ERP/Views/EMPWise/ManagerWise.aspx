    ...
    <div class="mp_right_content">
            ...
            <div><%--<div> Manager ID Wise</div>--%>
               ...
               <input type="button" value="Import Excel" title="Print"   onclick="printItemEx()" />
                <input type="button" value="Excel All" title="Print"   onclick="impexcel()" />
            </div>
...
<script type="text/javascript">
    function printItem() {
        alert("Report");
        window.open("/Configuration/AllManagerInforpt");
    }
</script>
<script type="text/javascript">
    function printItemEx() {
        alert("Report");
        window.open("/Configuration/AllManagerInforptExcel");
    }
</script>
...
<script type="text/javascript">
    function impexcel() {
        ...
        EX2 = $("#EndDate").val();
        EX3 = $("#EMPID").val();
        window.location = "/EMPWise/MgrwiseExcel?EX1=" + EX1 + "&EX2=" + EX2 + "&EX3=" + EX3;
    }
</script>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            pageSize: 31,
            sorting: false,
            title: ' Manager ID Wise',
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/EMPWise/AllManagerInfoList") %>'
            },
            fields: {
                //                    Id: {
                //                        key: true,
