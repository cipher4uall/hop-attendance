<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ERP.Master" Inherits="System.Web.Mvc.ViewPage<ERP.Domain.Model.BDEmployeedaycal>" %>
...
<div class="mp_left_menu">
    ...
    <div class="mp_right_content">
            ...
            <div><%--<div> BD Attendance Summary </div>--%>
...
<script type="text/javascript">
    function printItem() {
        alert("Report");
        window.open("/Summary/BDEmployeedaycalrpt");
    }
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            pageSize: 120,
            sorting: false,
            title: 'BD Attendance Summary',
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/Summary/BDEmployeedaycalList") %>'
            },
            fields: {
                //                    Id: {
                //                        key: true,
