<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ERP.Master" Inherits="System.Web.Mvc.ViewPage<ERP.Domain.Model.WelformdaycalEntity>" %>
...
<div class="mp_left_menu">
    ...
    <div class="mp_right_content">
            ...
            <div><%--<div> Welform Attendance Summary </div>--%>
...
<script type="text/javascript">
    function printItem() {
        alert("Report");
        window.open("/Summary/Welformdaycalrpt");
    }
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            pageSize: 120,
            sorting: false,
            title: 'Welform Attendance Summary',
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/Summary/WelformdaycalList") %>'
            },
            fields: {
                //                    Id: {
                //                        key: true,
